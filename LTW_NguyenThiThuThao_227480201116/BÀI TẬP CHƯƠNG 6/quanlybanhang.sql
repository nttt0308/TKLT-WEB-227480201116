...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 05:11 PM
...
--
-- Table structure for table `hang hoa`
--
...
--
-- Dumping data for table `hang hoa`
--

INSERT INTO `hang hoa` (`mahang`, `tenhang`, `mansx`, `namsx`, `gia`) VALUES
...
INSERT INTO `hoa don` (`mahd`, `makh`, `mahang`, `soluong`, `thanhtien`) VALUES
('001', 'K00', 'DE01', 2, 0),
('001', 'K00', 'DE02', 1, 0),
('002', 'K00', 'LE01', 5, 0),
('002', 'K00', 'LE02', 3, 0),
...
CREATE TABLE `khachhang` (
  ...
  `tenk` varchar(30) NOT NULL COMMENT 'Tên K.hàng',
...
INSERT INTO `khachhang` (`makh`, `tenk`, `namsinh`, `dienthoai`, `diachi`) VALUES
...
('K007', 'Lâm Hoài Bảo', 1990, '0912314415', 'Bạc Liêu'),
...
INSERT INTO `nha san xuat` (`mansx`, `tennsx`, `quocgia`) VALUES
('AS', 'ASUS', 'Dai Loan'),
('DE', 'DELL', 'Hoa Ky'),
